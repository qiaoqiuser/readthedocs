...
## [¶](#dispatcherservlet处理请求的过程) DispatcherServlet处理请求的过程？
...
![](img/spring-springframework-mvc-5-1.png)
...
![](img/spring-springframework-mvc-27.png)
...
![](img/spring-springframework-mvc-29.png)

后续invoke执行的方法，直接看整个请求流程的调用链即可

![](img/spring-springframework-mvc-30.png)

执行后获得视图和Model

![](img/spring-springframework-mvc-31.png)
